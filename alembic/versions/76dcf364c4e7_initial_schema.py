...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "currency", sa.String(length=3), server_default="PEN", nullable=False
        ),
        sa.Column(
            "status", sa.String(length=50), server_default="created", nullable=False
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "idx_processor_events_event_id", "processor_events", ["event_id"], unique=True
    )
    op.create_table(
        "ledger_entries",
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["related_event_id"], ["processor_events.event_id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["related_payout_id"], ["payouts.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["restaurant_id"], ["restaurants.id"], ondelete="RESTRICT"
        ),
